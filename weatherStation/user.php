    ...
    <div class="container marketing">
      ...
      <div class="row">
        ...
        $value = snap.val();
            if ( $value >= '28')
            {
              bootbox.alert("Cuaca Cerah Hari Ini");
            }
            else if ( $value >= '24')
            {
              bootbox.alert("Cuaca Sedang Mendung atau Gerimis Ringan Hari Ini");
            }
            else if ( $value >= '18')
            {
              bootbox.alert("Sedang Malam Hari atau Sedang Terjadi Hujan Hari Ini");
            }
        })
      </script>
      <p> </p>
      ...
      <?php
              ...
              while($data = mysqli_fetch_array($sql))
              {
                ...
                echo "<br><td><img src='images/".$data['foto']."' width='500' height='281'></td>";
